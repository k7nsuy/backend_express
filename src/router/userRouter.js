...
import {getCreateUser, getLoginUser, getGithubLogin, getLogoutUser, editUser, removeUser, postCreateUser, postLoginUser, getGithubCallback} from '../controller/userController.js'
...
userRouter.get('/logout', getLogoutUser);
